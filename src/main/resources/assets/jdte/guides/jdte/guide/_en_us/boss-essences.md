...
BOSS essences are unique items obtained by killing BOSS mobs with a Bio Crusher.
...
To obtain BOSS essences:

1. Build a Bio Crusher (Advanced or Extended)
2. Place it near a BOSS mob
3. The Bio Crusher will kill the BOSS and generate the corresponding essence

Note: The Bio Crusher must be powerful enough to kill BOSS mobs. It is recommended to use the Sharpness Upgrade to increase damage.
