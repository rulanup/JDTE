...
public class BasicItemReceiverScreen extends BaseMachineScreen<BasicItemReceiverContainer> {
    ...
    public void addFilterButtons() {
        ...
        addRenderableWidget(ToggleButtonFactory.ALLOWLISTBUTTON(
                leftPos + config.getBasicItemReceiverAllowlistX(),
                topSectionTop + config.getBasicItemReceiverAllowlistY(),
                filterData.allowlist, b -> {
                    filterData.allowlist = !filterData.allowlist;
                    saveSettings();
                }));
        addRenderableWidget(ToggleButtonFactory.COMPARENBTBUTTON(
                leftPos + config.getBasicItemReceiverCompareNBTX(),
                topSectionTop + config.getBasicItemReceiverCompareNBTY(),
        ...
        if (filterData.blockItemFilter != -1) {
            addRenderableWidget(ToggleButtonFactory.FILTERBLOCKITEMBUTTON(
                    leftPos + config.getBasicItemReceiverCompareNBTX(),
                    topSectionTop + config.getBasicItemReceiverCompareNBTY() + 18,
    ...
    public void addRedstoneButtons() {
        ...
        addRenderableWidget(ToggleButtonFactory.REDSTONEBUTTON(
                leftPos + config.getBasicItemReceiverRedstoneX(),
                topSectionTop + config.getBasicItemReceiverRedstoneY(),
    ...
    public void addAreaButtons() {
        ...
        addRenderableWidget(ToggleButtonFactory.RENDERAREABUTTON(
                leftPos + config.getBasicItemReceiverRenderAreaX(),
                topSectionTop + config.getBasicItemReceiverRenderAreaY(),
                renderArea, b -> {
    ...
    public void addTickSpeedButton() {
        ...
        addRenderableWidget(ToggleButtonFactory.TICKSPEEDBUTTON(
                leftPos + config.getBasicItemReceiverSpeedButtonX(),
                topSectionTop + config.getBasicItemReceiverSpeedButtonY(), tickSpeed, b -> {
