...
public abstract class ItemReceiverScreenBase<T extends ItemReceiverContainerBase> extends BaseMachineScreen<T> {
    ...
    private int allowlistX(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverAllowlistX() : config.getItemReceiverAllowlistX();
    }

    private int allowlistY(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverAllowlistY() : config.getItemReceiverAllowlistY();
    }

    private int compareNBTX(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverCompareNBTX() : config.getItemReceiverCompareNBTX();
    }

    private int compareNBTY(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverCompareNBTY() : config.getItemReceiverCompareNBTY();
    }

    private int redstoneX(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverRedstoneX() : config.getItemReceiverRedstoneX();
    }

    private int redstoneY(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverRedstoneY() : config.getItemReceiverRedstoneY();
    }

    private int renderAreaX(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverRenderAreaX() : config.getItemReceiverRenderAreaX();
    }

    private int renderAreaY(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverRenderAreaY() : config.getItemReceiverRenderAreaY();
    }

    private int speedButtonX(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverSpeedButtonX() : config.getItemReceiverSpeedButtonX();
    }

    private int speedButtonY(GuiUpgradeLayoutConfig config) {
        return useBasicLayout() ? config.getBasicItemReceiverSpeedButtonY() : config.getItemReceiverSpeedButtonY();
    }
