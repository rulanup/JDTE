...
public class BasicItemSenderScreen extends BaseMachineScreen<BasicItemSenderContainer> {
    ...
    public void addFilterButtons() {
        ...
        addRenderableWidget(ToggleButtonFactory.ALLOWLISTBUTTON(
                leftPos + config.getBasicItemSenderAllowlistX(),
                topSectionTop + config.getBasicItemSenderAllowlistY(),
                filterData.allowlist, b -> {
                    filterData.allowlist = !filterData.allowlist;
                    saveSettings();
                }));
        addRenderableWidget(ToggleButtonFactory.COMPARENBTBUTTON(
                leftPos + config.getBasicItemSenderCompareNBTX(),
                topSectionTop + config.getBasicItemSenderCompareNBTY(),
        ...
        if (filterData.blockItemFilter != -1) {
            addRenderableWidget(ToggleButtonFactory.FILTERBLOCKITEMBUTTON(
                    leftPos + config.getBasicItemSenderCompareNBTX(),
                    topSectionTop + config.getBasicItemSenderCompareNBTY() + 18,
    ...
    public void addRedstoneButtons() {
        ...
        addRenderableWidget(ToggleButtonFactory.REDSTONEBUTTON(
                leftPos + config.getBasicItemSenderRedstoneX(),
                topSectionTop + config.getBasicItemSenderRedstoneY(),
    ...
    public void addAreaButtons() {
        ...
        addRenderableWidget(ToggleButtonFactory.RENDERAREABUTTON(
                leftPos + config.getBasicItemSenderRenderAreaX(),
                topSectionTop + config.getBasicItemSenderRenderAreaY(),
                renderArea, b -> {
    ...
    public void addTickSpeedButton() {
        ...
        addRenderableWidget(ToggleButtonFactory.TICKSPEEDBUTTON(
                leftPos + config.getBasicItemSenderSpeedButtonX(),
                topSectionTop + config.getBasicItemSenderSpeedButtonY(), tickSpeed, b -> {
