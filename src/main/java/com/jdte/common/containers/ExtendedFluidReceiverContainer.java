...
public class ExtendedFluidReceiverContainer extends BaseMachineContainer {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, JDTEBlocks.EXTENDED_FLUID_RECEIVER.get());
    }
}
