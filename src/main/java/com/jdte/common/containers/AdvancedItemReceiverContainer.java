...
public class AdvancedItemReceiverContainer extends BaseMachineContainer {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, JDTEBlocks.ADVANCED_ITEM_RECEIVER.get());
    }
}
