...
public class AdvancedFluidSenderContainer extends BaseMachineContainer {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, JDTEBlocks.ADVANCED_FLUID_SENDER.get());
    }
}
