...
public class ExtendedItemSenderContainer extends BaseMachineContainer {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, JDTEBlocks.EXTENDED_ITEM_SENDER.get());
    }
}
