...
public abstract class FluidReceiverContainerBase extends BaseMachineContainer {
    private final Block machineBlock;

    protected FluidReceiverContainerBase(MenuType<?> menuType, int windowId, Inventory playerInventory,
