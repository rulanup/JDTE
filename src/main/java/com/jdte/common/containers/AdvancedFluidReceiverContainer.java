...
public class AdvancedFluidReceiverContainer extends BaseMachineContainer {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, JDTEBlocks.ADVANCED_FLUID_RECEIVER.get());
    }
}
