...
public abstract class SimpleMachineContainer extends BaseMachineContainer {
    private final Block machineBlock;

    protected SimpleMachineContainer(MenuType<?> menuType, int windowId, Inventory playerInventory,
