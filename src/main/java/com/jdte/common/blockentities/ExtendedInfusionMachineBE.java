...
public class ExtendedInfusionMachineBE extends InfusionMachineBE implements PoweredMachineBE, ExtendedUpgradeMachine {
    ...
    public ExtendedInfusionMachineBE(BlockPos pos, BlockState state) {
        super(JDTEBlockEntities.EXTENDED_INFUSION_MACHINE.get(), pos, state);
        tickSpeed = 20;
