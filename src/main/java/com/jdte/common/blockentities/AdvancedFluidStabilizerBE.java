...
public class AdvancedFluidStabilizerBE extends FluidStabilizerBE implements PoweredMachineBE {
    ...
    public AdvancedFluidStabilizerBE(BlockPos pos, BlockState state) {
        super(JDTEBlockEntities.ADVANCED_FLUID_STABILIZER.get(), pos, state);
        tickSpeed = 20;
