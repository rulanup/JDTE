...
public class ExtendedGlueActivatorBE extends GlueActivatorBE implements PoweredMachineBE, ExtendedUpgradeMachine {
    ...
    public ExtendedGlueActivatorBE(BlockPos pos, BlockState state) {
        super(JDTEBlockEntities.EXTENDED_GLUE_ACTIVATOR.get(), pos, state);
