...
public class JDTE {
    ...
    public JDTE(IEventBus modEventBus, ModContainer modContainer) {
        ...
        NeoForge.EVENT_BUS.addListener(EventPriority.LOWEST, BioCrusherDropEvents::onLivingDrops);
        NeoForge.EVENT_BUS.addListener(EventPriority.LOWEST, TimeMultitoolMiningEvents::onBreakSpeed);
        NeoForge.EVENT_BUS.addListener(EventPriority.LOWEST, BioCrusherDropEvents::onLivingExperienceDrop);
        ...
        NeoForge.EVENT_BUS.addListener(AEExtractionPlayerManager::onPlayerTick);
        NeoForge.EVENT_BUS.addListener(AEExtractionPlayerManager::onTooltip);
    ...
    private void registerCapabilities(RegisterCapabilitiesEvent event) {
        ...
        event.registerItem(Capabilities.EnergyStorage.ITEM,
                (stack, context) -> LargePocketGeneratorItem.createEnergyStorage(stack),
