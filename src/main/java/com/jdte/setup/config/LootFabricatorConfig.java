...
public class LootFabricatorConfig {
    ...
    public LootFabricatorConfig(ModConfigSpec.Builder builder) {
        ...
        lootFabricatorRecipeGenerationEnabled = builder
                .comment("When disabled, dynamic Loot Fabricator JEI recipes are not generated; the machine remains usable.")
                .translation("config.jdte.jdte.lootFabricator.recipeGenerationEnabled")
