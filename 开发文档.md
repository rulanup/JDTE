...
- 9 种升级卡：容量、超频、降频、流体、存储流体、发电机、范围、过滤、创造。
- 3 种时间加速器：初级、高级、扩展高级。
...
| 流体稳定器 | 单体 | `FluidStabilizerBE` | 使用催化剂槽匹配 JDT FluidDrop 配方，在配置范围内直接转换源流体 |
