...
8. `registerCapabilities()`：注册能量、流体和物品能力。
...
| `LOOTING` | `looting` | 6 | 生物粉碎机专用，增加额外掉落概率 |
| `SHARPNESS` | `sharpness` | 6 | 生物粉碎机专用，增加攻击伤害 |
...
- 当前页面：`index.md`、`upgrades.md`、`time-accelerator.md`、`extended-machines.md`、`extended-upgrade.md`、`bio-crusher.md`、`boss-essences.md`、`glue-activator.md`、`gel-generator.md`、`fluid-stabilizer.md`、`item-sender.md`、`fluid-sender.md`、`item-receiver.md`、`fluid-receiver.md`、`life-extractor.md`、`infusion-machine.md`
